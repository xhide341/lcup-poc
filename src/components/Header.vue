...
const menuItems = [
  ...
  },
  {
    ...
    hasDropdown: true,
    children: [
      { label: "Requirements", to: "#" },
      { label: "Application Process", to: "#" },
      { label: "Financial Aid", to: "#" },
  ...
  },
  {
    ...
    hasDropdown: true,
    children: [
      { label: "Student Services", to: "#" },
      { label: "Library", to: "#" },
      { label: "Health Services", to: "#" },
      { label: "Career Services", to: "#" },
    ],
  },
  {
    label: "Research",
    ...
    children: [
      ...
      { label: "Research Centers", to: "#" },
      { label: "Academic Journals", to: "#" },
      { label: "Research Opportunities", to: "#" },
    ],
  },
  {
    ...
    hasDropdown: true,
    children: [
      { label: "Community Outreach", to: "#" },
      { label: "Spiritual Formation", to: "#" },
      { label: "Service Learning", to: "#" },
      { label: "Values Integration", to: "#" },
    ],
  },
  {
    ...
    hasDropdown: true,
    children: [
      { label: "Exchange Programs", to: "#" },
      { label: "International Partners", to: "#" },
      { label: "Global Initiatives", to: "#" },
    ...
    <nav class="desktop-nav" aria-label="main navigation">
      <ul>
        ...
        >
          ...
          <RouterLink v-else :to="item.to" class="nav-link" :tabindex="0">
            {{ item.label }}
          </RouterLink>
      ...
      <ul>
        ...
        >
          <div class="mobile-nav-item">
            ...
            <template v-else>
              <a :href="item.to" @click.stop="isMobileMenuOpen = false" :tabindex="0">
                {{ item.label }}
              </a>
            </template>
            <div
  ...
  ul {
    ...
    li.nav-item {
      ...
      &.has-dropdown {
        ...
        ::v-deep(.has-dropdown .dropdown-icon path) {
          stroke: black;
          transition: stroke 0.3s ease;
        }

        ::v-deep(.has-dropdown:hover .dropdown-icon path) {
