    ...
    <main>
        <div class="hero-banner">
            ...
            <div class="partnership-logos">
                ...
                <div class="logos-row">
                    <img v-for="index in 7" :key="index" :src="lcupLogo" alt="Partner Logo" />
                </div>
            </div>                    
        </div>
...
.hero-banner {
    ...
    color: white;    
    background-image: linear-gradient(rgba($primary-color, 0.85), rgba($primary-color, 0.75)), url('../../assets/university-example.jpg');
    ...
    mask: 
      calc(100% - #{$inner-dimension} - #{$horizontal-offset}) 100% /#{$mask-dimension} #{$mask-dimension} radial-gradient(#000 70%,#0000 72%),
      100% calc(100% - #{$inner-dimension} - #{$vertical-offset}) /#{$mask-dimension} #{$mask-dimension} radial-gradient(#000 70%,#0000 72%),
